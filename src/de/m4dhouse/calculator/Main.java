...
import de.m4dhouse.calculator.gui.CalculatorGui;
    ...
    public static void main(String[] args) {
        ...
        if (guimode) {
            ...
            try {
                ...
                System.out.print("Zähler 1: ");
                if (sc.hasNextInt()) {x1 = sc.nextInt();}
                System.out.print("Nenner 1: ");
                if (sc.hasNextInt()) {y1 = sc.nextInt();}
                System.out.println();

                System.out.println("Wählen Sie den zweiten Zähler und Nenner");
                System.out.print("Zähler 2: ");
                if (sc.hasNextInt()) {x2 = sc.nextInt();}
                System.out.print("Nenner 2: ");
                if (sc.hasNextInt()) {y2 = sc.nextInt();}
                ...
                y = op.equals("+") ?
                    fraction1.add(fraction2) : op.equals("-") ?
                                               fraction1.sub(fraction2) : op.equals("*") ?
                                                                          fraction1.mul(fraction2) : fraction1.div(
                        fraction2);
